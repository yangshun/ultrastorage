...
:::info[Previously called greatstorage]
ultrastorage was previously published as `greatstorage`. Existing users can follow the
[migration guide](/guides/migration#from-greatstorage).
:::
...
:::danger[Store only data you can afford to lose]
...
can read them; see [Migration](/guides/migration).
...
- [Move existing data into or out of ultrastorage](/guides/migration).
